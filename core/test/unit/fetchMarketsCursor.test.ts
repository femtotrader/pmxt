...
describe('fetchMarkets cursor pagination', () => {
    it('should return consistent pages from a snapshot', async () => {
        ...
        const page3 = await exchange.fetchMarkets({ limit: 2, cursor: page2.nextCursor! });
    ...
    it('should reject expired cursor after TTL', async () => {
        ...
        await expect(
            exchange.fetchMarkets({ limit: 2, cursor: page1.nextCursor! })
