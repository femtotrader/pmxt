...
def main():
    ...
    k_trades = kalshi.fetch_trades(k_market.yes.outcome_id, pmxt.HistoryFilterParams(resolution='1h', limit=10))
    ...
    p_trades = poly.fetch_trades(p_market.yes.outcome_id, pmxt.HistoryFilterParams(resolution='1h', limit=10))
