...
description: "One API key. Every prediction market. Cross-venue search, matching, and price comparison."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Matched markets" icon="arrow-right-arrow-left" href="/router/prices#fetchmatchedmarkets">
  ...
  <Card title="Compose with venues" icon="puzzle-piece" href="/router/prices#composing-with-venue-exchanges">
    ...
    same schema — `marketId` works everywhere.
  </Card>
</CardGroup>
